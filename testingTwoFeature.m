function [seedMaskAll,combinedPvalue,mask_zz_ROI_idx] = testingTwoFeature(im,maskAll,prCurvature,imDiffAll,imDiffAll2,imSmoothed, boundingBoxCell, zz, lenx, leny, muRatio, sigmaRatio)
